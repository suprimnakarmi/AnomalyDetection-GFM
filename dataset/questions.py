...
def load_questions():
    ...
    print("Label shape: ", y_class.shape)  # using Class; change to y_label if preferred
    ...
    X_train, train_edge_index, y_train, X_test, test_edge_index, y_test=train_test_split(X,A,y_attr)
